  ...
  const sendMessage = (message) => {
    ...
    const data = {
      ...
      messages: [
        {
          role: "user",
          // prompt: `Generate a job description for the following role, skills, and experience:`,
          content:
            `Generate a job description for the following role, skills, and experience for the following:, keep it within 100 words ` +
            message,
        },
      ],
    };
